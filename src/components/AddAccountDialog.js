    ...
    >
      ...
      <DialogContent>
        ...
        <FormControl fullWidth sx={{ mt: 2 }} data-testid="currency-select">
          ...
          {!!formErrors.currency && (
            <Typography color="error">{formErrors.currency}</Typography>
          )}
        </FormControl>
      </DialogContent>
      <DialogActions>
        <Button onClick={() => setOpen(false)} data-testid="cancel-add-button">
          Cancel
        </Button>
        <Button onClick={handleAdd} data-testid="submit-button">
          Add
        </Button>
      </DialogActions>
    </Dialog>
